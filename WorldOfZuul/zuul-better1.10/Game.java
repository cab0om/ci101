...
public class Game 
{
    ...
    {
        Room outside, lobby, stockroom, stairs, upstairs, balcony, ladder, secret;
        ...
        secret = new Room("at a secret room, is it empty?");
        ...
        stockroom.setExit("east", secret);
        
        secret.setExit("west", stockroom);
